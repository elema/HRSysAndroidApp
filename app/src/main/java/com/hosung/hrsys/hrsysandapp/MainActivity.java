...
import static com.hosung.hrsys.hrsysandapp.R.id.nameTextView;
import static com.hosung.hrsys.hrsysandapp.R.id.radioFullTime;
import static com.hosung.hrsys.hrsysandapp.R.id.salaryhoursschoolTextView;
import static com.hosung.hrsys.hrsysandapp.R.id.txtMake;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtSalaryHoursSchool = (EditText) findViewById(R.id.txtSalaryHoursSchool);
        txtBonusRate = (EditText) findViewById(R.id.txtBonusRate);
        txtPlate = (EditText) findViewById(R.id.txtPlate);
        txtMake = (EditText) findViewById(R.id.txtMake);

        salaryhoursschoolTextView = (TextView) findViewById(R.id.salaryhoursschoolTextView);
        bonusrateTextView = (TextView) findViewById(R.id.bonusrateTextView);

        radioEmployeeGroup = (RadioGroup) this.findViewById(R.id.radioEmployeeGroup);
        ...
        btnCountryPicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PickerView pvd = (PickerView) outerView.findViewById(R.id.picker_view);
...
//                    Log.d(TAG,"bonus :" +txtBonusRate.getText().toString());
        ...
        // list
        Button btnEmpList = (Button) findViewById(R.id.btnEmpList);
